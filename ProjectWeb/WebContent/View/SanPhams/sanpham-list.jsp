							...
							<table class="table align-items-center table-dark table-flush">
								<thead class="thead-dark">
									<tr>
										...
										<th scope="col">Tính năng/Mô tả</th>
									...
									<c:forEach var="sanpham" items="${listOfSanPham}">
										<tr>
											...
											<td><span class="badge badge-dot mr-4"> <i
													class="bg-warning"></i>
												<c:out value="${sanpham.gia}" />
											</span></td>
											<td>
												<div class="avatar-group">
													<c:out value="${sanpham.soLuongKho}" />
													/
													<c:out value="${sanpham.soLuongBan}" />
												</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<c:out value="${sanpham.tinhNang}" />
													/
													<c:out value="${sanpham.moTa}" />
												</div>
											</td>
											<td>
												<div class="avatar-group">
