				...
				<div class="col">
					<div class="card bg-default shadow">
						<div class="card-header bg-transparent border-0">
							<h3 class="text-white mb-0">Danh sách đơn hàng</h3>
						</div>
												...
												<div class="media align-items-center">
													<div class="media-body">
														<span class="mb-0 text-sm"><c:out
																value="${donhang.hoTen}" /></span>
													</div>
												</div>
											</th>
											<td><c:out value="${donhang.maDh}" /></td>
											<td><span class="badge badge-dot mr-4"> <i
													class="bg-warning"></i> <c:out value="${donhang.trangThai}" />
											</span></td>
											<td>
												<div class="avatar-group">
													<c:out value="${donhang.sdt}" />

												</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<c:out value="${donhang.tongTien}" />
												</div>
											</td>
											<td>
												<div class="avatar-group">
													<c:out value="${donhang.ngayMua}" />
												</div>
											</td>
												...
												<div class="dropdown">
													...
													<form action="DonHang" method="get">
														<input type="submit" value="Chỉnh sửa"
															...
															name="maDh" value="<c:out value='${donhang.maDh}' />" />
													</form>
												</div>
												<div class="dropdown">
													<form action="DonHang" method="get">
														...
														<input type="hidden" name="action" value="delete" /> <input
															type="hidden" name="maDh"
															value="<c:out value='${donhang.maDh}' />" />
													</form>
												</div>
												<div class="dropdown">
													<form action="ChiTietDonHang" method="get">
