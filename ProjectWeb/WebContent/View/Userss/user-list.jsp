									...
									<c:forEach var="user" items="${listUser}">
										<tr>
											...
											<td><span class="badge badge-dot mr-4"> <i
													class="bg-warning"></i> <c:out value="${user.sdt}" />
											</span></td>
											<td>
												<div class="avatar-group">
													<c:if test="${user.allowed eq 1}">Quản lý</c:if>
													<c:if test="${user.allowed eq 2}">Khách hàng</c:if>
												</div>
											</td>
											<td>
												<div class="d-flex align-items-center">
													<span class="mr-2"> <c:out value="${user.address}" /></span>
												</div>
											</td>
											<td class="text-right">
												<div class="dropdown">
													...
													<form action="TaiKhoan" method="post">
														<input type="submit" value="Chỉnh sửa"
															...
															name="id" value="<c:out value='${user.userId}' />" />
													</form>
												</div>
												<div class="dropdown">
													<form action="TaiKhoan" method="post">
														<input type="submit" value="Xóa" style="width: 100px"
															class="dropdown-item" /> <input type="hidden"
